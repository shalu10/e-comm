...
<%@include file="navbar.jsp" %>
  ...
  <header class="w3-display-container w3-wide" id="home">
    <img src="./resource/image/bg.jpg" alt="Fashion Blog" width="1600" height="500">
    <div class="w3-display-left w3-padding-large">
      <h1 class="w3-text-white">Hercule's</h1>
      <h1 class="w3-jumbo w3-text-white w3-hide-small"><b>RIDE SHINE</b></h1>
    </div>
  </header>
  <br>
  <br>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><a href="productdesc"><img src="./resource/image/bik1.jpg" class="img-responsive" style="width:100%" alt="Image" ></a></div>
        <div class="panel-footer"><a class=""btn btn-warning" role="button" href="product_details.html">VIEW</a> <span class="pull-right">Price:$188.00</span></div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-danger">
        <div class="panel-heading">Hitman Absolution Professional Edition</div>
        <div class="panel-body"><a href="productdesc"><img src="./resource/image/bik2.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-success">
        ...
        <div class="panel-body"><a href="productdesc"><img src="./resource/image/bik3.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><a href="productdesc"><img src="./resource/image/bik4.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-danger">
        ...
        <div class="panel-body"><a href="productdesc"><img src="./resource/image/bik5.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-success">
        ...
        <div class="panel-body"><a href="productdesc"><img src="./resource/image/bik6.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
